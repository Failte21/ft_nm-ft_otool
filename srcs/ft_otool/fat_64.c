...
/*   Updated: 2018/12/03 08:06:30 by lsimon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../inc/ft_otool.h"

static t_print_infos        *get_fat_macho(t_file *f, struct fat_arch_64 *c, bool swap)
{
	t_print_infos	*curr;
...
static t_print_infos	    *get_fat_infos(t_file *f, struct fat_arch_64 *c, uint32_t n, bool swap)
{
	t_print_infos	*curr;
